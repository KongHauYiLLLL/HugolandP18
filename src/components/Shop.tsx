...
export const Shop: React.FC<ShopProps> = ({ coins, onOpenChest, onDiscardItem, isPremium, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-40 p-4">
      <div className="bg-gradient-to-br from-yellow-900 via-orange-900 to-red-900 p-4 sm:p-6 rounded-lg shadow-2xl max-w-4xl w-full max-h-[80vh] overflow-y-auto">
